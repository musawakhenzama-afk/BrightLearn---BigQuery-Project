# BrightLearn---BigQuery-Project
Practical exercise (Google BigQuery)
BRIGHTLEARN Practical exercise (Google BigQuery)
...
8. Q7. For each Gender, count how many high-value transactions occurred (where Total Amount > 500). Expected output: Gender, High_Value_Transactions
8. HAVING Clause
